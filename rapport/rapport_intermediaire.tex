...
\begin{tikzpicture} 
\begin{umlseqdiag}
\umlobject[class=Router]{r} 
\umlobject[class=Controler]{c}
\begin{umlcall}[op={connection}]{r}{c}
\begin{umlcall}[type=return]{c}{r}\end{umlcall}
\begin{umlcall}[op={get\_neighbours}, return=newList]{r}{c}\end{umlcall}
\begin{umlcall}[op={set\_neighbours}]{r}{r}\end{umlcall}
\begin{umlcall}[op={disconnection}]{r}{c}\end{umlcall}
\begin{umlcall}[type=return]{c}{r}\end{umlcall}
\end{umlcall} 
\end{umlseqdiag} 
\end{tikzpicture}
